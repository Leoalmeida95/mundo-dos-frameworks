...
SECRET_KEY = '@*rq3mv+i19pz#v3r9jo4!$w6ph)a6_lp^pm(3s2)bbg0uwax('
...
#configura os arquivos para compressão
...
#configura o usuário do modelo para o criado no models.py
AUTH_USER_MODEL = "wofapp.Usuario"
#configura as paginas de redirect do login
LOGIN_URL= '/'
LOGIN_REDIRECT_URL = '/'
